...
Cuz they are the only three faces of poker cards.

However, a 10 also counts just like these face cards in Blackjack.

So at the end, **monkey is a symbol of 10, J, Q and K.**

Take a moment to think about one question:
...
Their rules are quite interesting in some parts. For example:
...
4. At that time, I saw a flexible surrender policy in Wynn Palace & MGM Cotai:
   ...
   Of course, these were from some years ago, **so I don't know if such a policy still exists🤣**

**The more interesting these rules are, the harder it is to implement into an online game.**
...
Especially if you discover bugs, then I am very willing to know and debug 🙏

### Follow-up
Maybe you will feel curious: why do 🇲🇴 casinos give so many friendly rules?

Then try to think about: which Blackjack rule is the root cause for house edge?
